...
import os
from features.editing_plan.generator import (
...
def main():
    ...
    sample_transcript = [
        {
            'start': 0.0,
            'end': 4.2,
            'text': ' Welcome to the AI Technology Podcast.'
        },
        {
            'start': 4.2,
            'end': 8.5,
    ...
    print("\nGenerating editing plan using GPT-4...")
    ...
    try:
        ...
        print("Each decision includes timestamps, the feature to use, and the reasoning.\n")
