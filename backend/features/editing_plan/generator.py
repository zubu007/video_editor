...
from backend.features.editing_plan.llm_client import DEFAULT_MODEL, EditingPlanLLM
...
def filter_editing_plan_by_feature(editing_plan: list, feature_names: list) -> list:
    ...
    """
    return [
        decision for decision in editing_plan if decision["feature"] in feature_names
    ]
